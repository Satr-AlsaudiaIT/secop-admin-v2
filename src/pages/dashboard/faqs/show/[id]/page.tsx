        ...
        <Row>
          <Col span={24}>
            <Descriptions bordered title={<FormattedMessage id="show" />}>
              <Descriptions.Item span={3} label={<FormattedMessage id="question_en" />}>
                {data.question_en ?? (
              ...
              <Descriptions.Item span={3} label={<FormattedMessage id="answer_en" />}>
                {data.answer_en ? (
                  <div dangerouslySetInnerHTML={{ __html: data.answer_en }}></div>
                ) : (
                  <div className="text-[#ccc]">
                    <FormattedMessage id="noData" />
                  </div>
              ...
              <Descriptions.Item span={3} label={<FormattedMessage id="question_ar" />}>
                {data.question_ar ?? (
                  <div className="text-[#ccc]">
                    <FormattedMessage id="noData" />
                  </div>
              ...
              <Descriptions.Item span={3} label={<FormattedMessage id="answer_en" />}>
                {data.answer_ar ? (
                  <div dangerouslySetInnerHTML={{ __html: data.answer_ar }}></div>
                ) : (
                  <div className="text-[#ccc]">
                    <FormattedMessage id="noData" />
                  </div>
